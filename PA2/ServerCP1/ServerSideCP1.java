		...
		try {
			...
			while (!connectionSocket.isClosed()) {
				...
				// If the packet is for transferring a chunk of the file
					...
					System.out.println("Encrypted file chunks: "+new String(block));
					...
					System.out.println("Decrypted file chunks: "+new String(decryptedBlock));
...
//						bufferedFileOutputStream.flush();
					...
					if (numBytes < 117) {
						System.out.println("File transmission ends here");
